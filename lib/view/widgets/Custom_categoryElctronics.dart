...
class CustomCategoryElctronics extends StatefulWidget {
  const CustomCategoryElctronics({
    super.key,
    required this.width,
...
final String  category;
  @override
  State<CustomCategoryElctronics> createState() => _CustomCategoryElctronicsState();
}

class _CustomCategoryElctronicsState extends State<CustomCategoryElctronics> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Consumer<ProductsBasedOnCategoryProvider>(
      ...
      builder: (context, usersProductProvider, child) {
             ...
             } else if (usersProductProvider.ElctronicProduct.isEmpty) {
               return const Center(
       ...
       const  SliverGridDelegateWithFixedCrossAxisCount(
          ...
          shrinkWrap: true, itemBuilder: (context,index){
           ProductModel currenProduct =
                         usersProductProvider.ElctronicProduct[index];
